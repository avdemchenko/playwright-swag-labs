...
import { isLockedOutErrorMessageDisplayed, isShoppingCartDisplayed } from "../pages/home.page";
...
Then('I should see user locked out error message', async () => {
    await expect(isLockedOutErrorMessageDisplayed).toBeTruthy();
});
